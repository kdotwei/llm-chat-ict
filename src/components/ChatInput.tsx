...
export default function ChatInput({
  ...
  return (
    <footer className="border-t border-gray-200 bg-white px-3 py-3 shadow-[0_-1px_4px_rgba(0,0,0,0.06)] dark:border-gray-700 dark:bg-gray-800 sm:px-4">
